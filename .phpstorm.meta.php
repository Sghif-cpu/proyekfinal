...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\LENOVO X250\Documents\GitHub\proyekfinal\public\storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links.C:\\Users\\LENOVO X250\\Documents\\GitHub\\proyekfinal\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'logout','dashboard','pasien.index','pasien.create','pasien.store',
'pasien.show','pasien.edit','pasien.update','pasien.destroy','pendaftaran.index',
'pendaftaran.create','pendaftaran.store','pendaftaran.show','pendaftaran.edit','pendaftaran.update',
'pendaftaran.destroy','pendaftaran.cetak','rekam-medis.index','rekam-medis.create','rekam-medis.store',
'rekam-medis.show','rekam-medis.edit','rekam-medis.update','rekam-medis.destroy','rekam-medis.print',
'lab.index','lab.create','lab.store','lab.edit','lab.update',
'lab.destroy','lab.byRekamMedis','lab.show','obat.index','obat.create',
'obat.store','obat.show','obat.edit','obat.update','obat.destroy',
'dokter.index','dokter.create','dokter.store','dokter.show','dokter.edit',
'dokter.update','dokter.destroy','dokter.byPoli','poli.index','poli.create',
'poli.store','poli.show','poli.edit','poli.update','poli.destroy',
'penjamin.index','penjamin.create','penjamin.store','penjamin.show','penjamin.edit',
'penjamin.update','penjamin.destroy','transaksi.index','transaksi.create','transaksi.store',
'transaksi.show','transaksi.edit','transaksi.update','transaksi.destroy','transaksi.bayar',
'transaksi.print','storage.local',);
        registerArgumentsSet('views', 
'auth.login','dashboard','dokter.create','dokter.edit','dokter.index',
'dokter.show','lab.create','lab.edit','lab.index','lab.show',
'layouts.app','obat.create','obat.edit','obat.index','obat.show',
'partials.sidebar','pasien.create','pasien.edit','pasien.index','pasien.show',
'pendaftaran.cetak','pendaftaran.create','pendaftaran.index','pendaftaran.show','penjamin.create',
'penjamin.edit','penjamin.index','penjamin.show','poli.create','poli.edit',
'poli.index','poli.show','rekam_medis.create','rekam_medis.edit','rekam_medis.index',
'rekam_medis.show','transaksi.create','transaksi.edit','transaksi.index','transaksi.show',
...
'C:.Users.LENOVO X250.Documents.GitHub.proyekfinal.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
